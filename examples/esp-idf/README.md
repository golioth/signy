...
The examples in this directory demonstrate how to use `signy` with
[ESP-IDF](https://idf.espressif.com/).

## Common Setup

All ESP-IDF examples require configuring valid credentials and setting the
device system time. Some examples may require additional configuration as
described in the respective `README.md`.
